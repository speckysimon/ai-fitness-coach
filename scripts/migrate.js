...
const DB_PATH = process.env.DATABASE_PATH || path.join(__dirname, '../server/fitness-coach.db');
...
const applied = db.prepare('SELECT name FROM migrations ORDER BY id').all();
