...
import { X, Sparkles, AlertCircle, CheckCircle, Loader2, Brain, Info } from 'lucide-react';
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-amber-900">
                    <p className="font-semibold mb-1">Note: This adjusts existing sessions only</p>
                    <p className="text-amber-800">
                      To extend your plan or add more weeks, use the <strong>"Regenerate Plan"</strong> button and update your event date.
                    </p>
                  </div>
                </div>
              </div>
