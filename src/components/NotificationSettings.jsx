            ...
            {preferences.enabled && (
              <div className="space-y-4">
                ...
                {preferences.motivationFrequency !== 'never' && (
                  <div className="p-4 rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-2 border-purple-200 dark:border-purple-800">
